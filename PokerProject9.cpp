...
void river(vector<Card>, Player Dealer, Player User);
...
void river(vector<Card> mainDeck, Player Dealer, Player User) {
...
int main() {
    ...
    cout << "*** Turn ***\n";
    turn(mainDeck, Jarvis, user);
    
    cout << "*** River ***\n";
    river(mainDeck, Jarvis, user);
    cout << "\n";
